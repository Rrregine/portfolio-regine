    ...
    {
        {
            ...
            { "Skill2Description", "Experienced in designing and implementing robust software architectures, including microservices and cloud-native applications, with a strong understanding of databases like MongoDB, MySQL, and PostgreSQL." },
            { "Skill3Title", "Agile & Team Collaboration" },
        ...
        },
        {
            ...
            { "Skill2Description", "Expérience dans la conception et la mise en œuvre d'architectures logicielles robustes, y compris des microservices et des applications cloud-native, avec une bonne compréhension des bases de données comme MongoDB, MySQL et PostgreSQL." },
            { "Skill3Title", "Agile & Collaboration en équipe" },
